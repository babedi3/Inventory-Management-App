<template>
  <div class="inventory-container">
    ...
    <div class="inventory-actions">
      <inventory-button @button:click="showNewProductModal" id="addNewBtn">
        Add New Item</inventory-button>
      <inventory-button @button:click="showShipmentModal" id="receiveShipmentBtn">
        Receive Shipment
      </inventory-button>
    </div>
    ...
    <table id="inventoryTable" class="table">
     ...
     <new-product-modal
      v-if="isNewProductVisible" @save:product="saveNewProduct" @close="closeModals"/>

    <shipment-modal
      v-if="isShipmentVisible" :inventory="inventory" @save:shipment="saveNewShipment" @close="closeModals"/>
  </div>
</template>
...
@Component({
  name: "Inventory",
  components: {InventoryButton, NewProductModal, ShipmentModal, InventoryChart},
})
...
<style scoped lang="scss">
    ...
    .yellow {
    font-weight: bold;
    color: $inventory-yellow;
    }

    .green {
    font-weight: bold;
    color: $inventory-green;
    }
    .red {
    font-weight: bold;
    color: $inventory-red;
