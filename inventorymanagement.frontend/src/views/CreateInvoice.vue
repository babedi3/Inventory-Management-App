<template>
  <div>
    ...
    <div class="invoice-step" v-if="invoiceStep === 3">
      ...
      <inventory-button @button:click="submitInvoice"
        >Submit Invoice</inventory-button
      >
      <hr />
      ...
      <div class="invoice-step-detail" id="invoice" ref="invoice">
        <div class="invoice-logo">
          ...
          />
          <h3>1444 address Lane</h3>
          <h3>Somewhere, CA 90000</h3>
          <h3>USA</h3>
    ...
    <div class="invoice-steps-actions">
      <inventory-button @button:click="prev" :disabled="!canGoPrev"
        >Previous</inventory-button
      >
      <inventory-button @button:click="next" :disabled="!canGoNext"
        >Next</inventory-button
      >
      <inventory-button @button:click="startOver">Start Over</inventory-button>
    </div>
  </div>
</template>
...
@Component({ name: "CreateInvoice", components: { InventoryButton } })
